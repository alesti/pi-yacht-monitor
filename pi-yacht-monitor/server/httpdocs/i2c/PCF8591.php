...
class PCF8591 extends I2C{
  ...
  public function getNewForm($action) {
    ...
    $res .= "<input type=\"hidden\" name=\"typ\" value=\"$typ\"/>";
    $res .= "<input type=\"hidden\" name=\"bus\" value=\"$bus\"/>";
    $res .= "<input type=\"hidden\" name=\"active\" value=\"$active\"/>";
    $res .= "<input type=\"hidden\" name=\"name\" value=\"$name\"/>";
    $res .= "<input type=\"hidden\" name=\"address\" value=\"$address\"/>";
    $res .= "</td></tr>";
    $res .= "</table>";
    $res .= "</form>";
    return $res;
