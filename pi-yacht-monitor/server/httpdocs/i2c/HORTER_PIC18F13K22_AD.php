...
class HORTER_PIC18F13K22_AD extends I2C{
  public $port0active;
  public $port0name;
  public $port0factor;
  public $port1active;
  ...
  public function getNewForm($action) {
    ...
    $res .= "<tr><td>5</td><td><input name=\"in-4-active\" type=\"checkbox\"/></td><td><input name=\"in-4-name\" type=\"text\"/></td><td><input name=\"in-4-factor\" type=\"text\"></td></tr>";
